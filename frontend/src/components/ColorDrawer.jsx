      ...
      >
        <Box
          ...
          sx={{
            ...
            width: configuration === 1 ? '16em' : '100%',
            pt: configuration === 2 && '1em',
            height: configuration === 1 ? '16em' : 'auto',
            mt: configuration === 1 && '2em',
            position: configuration === 1 && 'relative',
            transition: '1s ease',
          }}
        >
          <ColorPicker
        ...
        >
          ...
          <Button
            ...
            onClick={() => setConfiguration(configuration === 1 ? 2 : 1)}
          >
